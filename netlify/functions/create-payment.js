...
exports.handler = async (event) => {
  ...
  const { amount, rate_id, customer_email, ref, carrier, service, weight_declared, weight_unit, weight_buffered_lbs, name, phone, origin, destination, origin_zip, destination_zip } = JSON.parse(event.body || '{}');
